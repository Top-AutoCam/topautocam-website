<div id="content" class="site-content uk-height-small" >
                    <div id="slider" class="site-slider modern-layout">
                        <div class="uk-container uk-container-expand">
                            <div class="inner uk-position-relative uk-visible-toggle">
                                <div class="owl-carousel">
                                    <div class="item">
                                        <article class="post type-post">
                                            <div class="entry-outer uk-grid uk-grid-collapse uk-child-width-1-2@m uk-flex" data-uk-grid="">
                                                <div class="entry-thumb">
                                                    <div class="image cover-image ratio-square" data-src="{{ asset('images/alphard19-20.jpg') }}" data-uk-img="" title="Post Title"></div>
                                    ...
                                    <div class="item">
                                        <article class="post type-post">
                                            <div class="entry-outer uk-grid uk-grid-collapse uk-child-width-1-2@m uk-flex" data-uk-grid="">
                                                <div class="entry-thumb">
                                                    <div class="image cover-image ratio-square" data-src="{{ asset('images/vitz08-09.jpg') }}" data-uk-img="" title="Post Title"></div>
                                    ...
                                    <div class="item">
                                        <article class="post type-post">
                                            <div class="entry-outer uk-grid uk-grid-collapse uk-child-width-1-2@m uk-flex" data-uk-grid="">
                                                <div class="entry-thumb">
                                                    <div class="image cover-image ratio-square" data-src="{{ asset('images/alphard08.jpg') }}" data-uk-img="" title="Post Title"></div>
                                                    <a class="link-overlay uk-position-cover" href="single.html"></a>
                                                </div>
                                                <div class="entry-inner uk-flex uk-flex-center uk-flex-middle uk-flex-first@m">
                                                    <div class="entry-content">
