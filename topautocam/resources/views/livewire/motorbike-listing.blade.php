<div id="modal-motobike" uk-modal>
                        ...
                        <ul class="products columns-4">
                            ...
                            <li class="product type-product has-post-thumbnail " uk-parallax="opacity: 0,1; y: 100,0; viewport: 0.5">
                                <a href="{{ route('motorbike-detail', $motorbike->id) }}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link " >
                                    ...
                                    <h2 class="woocommerce-loop-product__title khmer-title-font" style="font-size: 15px;">{{  $motorbike->title }}</h2>
                                    <span class="price">
                                        <span class="woocommerce-Price-amount amount">
                                            <span class="woocommerce-Price-currencySymbol">{{ $motorbike->make }} | {{ $motorbike->model }}</span>
                                        </span>
                                ...
                                @guest
                                @else
                                    <span class="uk-badge uk-margin">${{ $motorbike->price }}</span>
                                @endguest
                            </li>
                            @endforeach
                        </ul>
